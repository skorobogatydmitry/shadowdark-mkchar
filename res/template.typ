...
#stack(
  ...
  box(width: 25%, align(top, [
    ...
    #table(
      ...
      ..for stat in inputs.stats {
        (table.cell(colspan: 2, inset: (top: 30%), [
      ...
      #table(
        ...
        table.cell(stroke: .5pt, align: left, inset: (y: 10%, x: 3%), [
          #inputs.ancestry_feature.description]),
      )
    ])),
  box(width: 40%, align(top, [
    #set text(4pt, font: "Hermann-GotischC")
  ...
  box(width: 30%, align(top, [
    ...
    #table(
      ...
      stroke: none,
      inset: (x: 1pt, y: 2pt),
        table.cell(stroke: .5pt, colspan: 2, align: center, [
          #set text(8pt, font: "Hermann-GotischC")
